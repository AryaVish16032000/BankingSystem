...
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(){
        ...
        l5 = new JLabel("(Your Account number)");
        ...
        c7 = new JCheckBox("I hereby declares that all the above details are correct to the best of my knowledge.",true);
        ...
        l11.setBounds(10,10,70,30);
        add(l11);
        
        t1.setBounds(10,10,40,30);
        add(t1);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        long first7 = (ran.nextLong() % 900000L) + 5040936000L;
